declare module '@justinwwolcott/ez-web-crypto' {
  export default class EZ_WEB_CRYPTO {
    ...
    EcEncrypt(b64Private: string, b64Public: string, b64data: string): Promise<{ ciphertext: string; iv: string }>
    EcDecrypt(b64Private: string, b64Public: string, b64Nonce: string, b64data: string): Promise<ArrayBuffer>
    HKDFEncrypt(
      b64Private: string,
      b64Public: string,
      b64data: string
    ...
    EcVerifySig(b64PublicKey: string, b64Signature: string, b64data: string): Promise<boolean>
